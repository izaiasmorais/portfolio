			...
			<div className="flex flex-col sm:flex-row gap-4">
				...
				<div className="flex flex-col gap-2">
					<p className="text-sm text-muted-foreground leading-relaxed">
						<span className="font-medium text-foreground/70">{t.ui.certificate.skills}: </span>
						{skills}
					</p>

					<p className="text-sm text-muted-foreground leading-relaxed">
						<span className="font-medium text-foreground/70">{t.ui.certificate.workload}: </span>
						{t.ui.certificate.workloadValue}
					</p>

					<p className="text-sm text-muted-foreground leading-relaxed">
						<span className="font-medium text-foreground/70">{t.ui.certificate.contentType}: </span>
