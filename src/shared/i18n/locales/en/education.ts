					...
					certificates: [
						{
							...
							skills:
								"ReactJS Fundamentals, Creating SPAs with ReactJS, API Consumption and Performance in ReactJS, Next.js Fundamentals, Design System and Storybook, and FullStack Application Development with NextJS.",
						},
					],
				},
			],
