...
export function ThemeSwitcher() {
	...
	if (!mounted) {
		return <div className="size-9 rounded-md border border-border bg-secondary animate-pulse" />
	}

	return (
		<GlowButton variant="secondary" size="icon" onClick={toggleTheme} aria-label="Toggle theme">
			{getIcon()}
		</GlowButton>
	)
}
